...
const CHARSET: &str = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789 .,:!?/-+%()[]|\u{F04D4}\u{F2DB}\u{F04C5}\u{F040A}\u{F0343}\u{F091}\u{F0594}\u{F0579}\u{F0411}";
...
pub const ICON_AUDIO: char = '\u{F0579}';
pub const ICON_MUSIC: char = '\u{F0411}';
